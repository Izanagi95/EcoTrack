...
graph TD
    ...
    App -->|Lead Generation| Partners[Brand Green & Utility]
    Partners -->|Commissioni/Sconti| App
    Partners -->|Premi/Vantaggi| User
    
    Local[Negozi di Quartiere] -->|Premi Fisici| User
    User -->|Acquisti Circolari| Local
    App -->|Visibilità Locale| Local
```
