...
1.  **Analisi Energetica Intelligente**: L'uso di Gemini AI per leggere le bollette automatizza la raccolta dati sui consumi (luce, gas, acqua), fornendo all'utente suggerimenti immediati su come ottimizzare l'uso delle risorse domestiche.
2.  **Tracking Multi-settore**: Copre cinque aree critiche: Energia, Riciclo, Volontariato, Economia Circolare e Mobilità Sostenibile (bici/bus).
3.  **Gamification (EcoScore & Livelli)**: Gli utenti guadagnano punti in base al CO2 risparmiato, creando un circolo virtuoso di gratificazione.
